...
public class Assertion_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.ctakes.assertion.medfacts.types.Assertion");
  ...
  public String getAssertionType(int addr) {
      ...
      jcas.throwFeatMissing("assertionType", "org.apache.ctakes.assertion.medfacts.types.Assertion");
  ...
  public int getAssociatedConcept(int addr) {
      ...
      jcas.throwFeatMissing("associatedConcept", "org.apache.ctakes.assertion.medfacts.types.Assertion");
  ...
  public Assertion_Type(JCas jcas, Type casType) {
    ...
    casFeat_associatedConcept = jcas.getRequiredFeatureDE(casType, "associatedConcept", "org.apache.ctakes.assertion.medfacts.types.Concept", featOkTst);
