  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     FeatureStructure fs = DiseaseDisorderMention_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new DiseaseDisorderMention(addr, DiseaseDisorderMention_Type.this);
  			   DiseaseDisorderMention_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new DiseaseDisorderMention(addr, DiseaseDisorderMention_Type.this);
  	  }
    };
  /** @generated */
